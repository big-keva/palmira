...
//-------------------------------------------------------------------------//
  auto parse_query_object(simdjson::ondemand::object query_object) -> query_node_t
  {
    ...
    for (auto query_field_result : query_object)
    {
      ...
      throw_if_error(std::move(query_field_result).get(query_field),
      ...
      if (query_key == "match")
      {
        ...
        throw_if_error(query_value.get_object().get(match_object),
                       "match query must be object");
      ...
      else if (query_key == "term")
      {
        ...
        throw_if_error(query_value.get_object().get(term_object),
                       "term query must be object");
      ...
      else if (query_key == "terms")
      {
        ...
        throw_if_error(query_value.get_object().get(terms_object),
                       "terms query must be object");
      ...
      else if (query_key == "range")
      {
        ...
        throw_if_error(query_value.get_object().get(range_object),
                       "range query must be object");
      ...
      else if (query_key == "bool")
      {
        ...
        throw_if_error(query_value.get_object().get(bool_object),
                       "bool query must be object");

        query->kind = query_kinds::bool_query;
