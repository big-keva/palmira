...
namespace restAPI
{
    ...
    auto  deldoc = [functor = *this]()
    {
      ...
      try
      {
        ...
        */
        ...
        update = functor.search->Update( { functor.sDocId,
  ...
  auto  UpdateEntity::SetIndex( std::string_view ix ) -> UpdateEntity&
  {
    return sIndex = ix, *this;
  }

  auto  UpdateEntity::SetDocId( std::string_view id ) -> UpdateEntity&
  {
