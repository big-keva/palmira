...
namespace grpcapi
{
  ...
  using Search = grpcttp::Search;

  using InsertArgs = grpcttp::InsertArgs;
  using UpdateArgs = grpcttp::UpdateArgs;
  using RemoveArgs = grpcttp::RemoveArgs;

  using UpdateReport = grpcttp::UpdateReport;
  ...
  class Server final: public palmira::IServer
  {
    ...
    public:
      ...
      auto  Search(
        grpc::CallbackServerContext* context,
        const SearchArgs*            request,
        SearchReport*                respond ) -> grpc::ServerUnaryReactor* override;
      */
    ...
    protected:
      template <
        class IntRequest,
        mtc::api<palmira::IService::IPending> (palmira::IService::*Method)( const IntRequest&, palmira::IService::NotifyFn ),
        class PubRequest>
      auto  Change(
        grpc::CallbackServerContext*  context,
    ...
    UpdateReport*                respond ) -> grpc::ServerUnaryReactor*
  {
    ...
    try
    {
      ...
      Convert( *respond, (search->*Method)( Convert( thearg, *request ), nullptr )
        ->Wait() );
    }
    catch ( ... )
    {
