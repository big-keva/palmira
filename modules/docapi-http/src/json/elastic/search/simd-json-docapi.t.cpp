...
{
  EXPECT_THROW(docapi::json::validate_json_object(""),
...
TEST(SimdJsonDocumentApiParserTest, RejectInvalidIndexDocumentBody)
{
  ...
  EXPECT_THROW(docapi::json::validate_json_object(body),
               docapi::json::parse_error);
}
...
TEST(SimdJsonDocumentApiParserTest, RejectMgetIdsFormWithoutDefaultIndex)
{
  ...
  EXPECT_THROW(docapi::json::elastic::parse_mget_request(body, ""),
               docapi::json::parse_error);
}
